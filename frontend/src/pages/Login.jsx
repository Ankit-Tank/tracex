    ...
    <div className="min-h-screen bg-bgSubtle flex flex-col justify-center items-center px-4 py-8 select-none">
      ...
      <div className="max-w-[380px] w-full bg-bg border border-border rounded p-6 shadow-none">
        ...
        <div className="flex items-center gap-2.5 mb-5 pb-4 border-b border-border">
          <div className="w-8 h-8 rounded bg-accent text-white flex items-center justify-center flex-shrink-0">
            <Shield className="w-4 h-4" />
          </div>
          <div className="flex flex-col">
            <h1 className="text-[15px] font-semibold text-text tracking-tight leading-tight">
              TraceX
            </h1>
